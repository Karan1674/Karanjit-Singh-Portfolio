...
function animateProjects() {
    ...
    document.querySelectorAll('.project-gallery .projects-grid .project-card').forEach((item, i) => {
...
function animateFreelanceProjects() {

    document.querySelectorAll('.freelance-gallery .projects-grid .project-card').forEach((item, i) => {
...
function initScrollAnimations() {
    ...
    ScrollTrigger.create({
        trigger: '.freelance-section',
        start: "top 60%",
        once: true,
        onEnter: animateFreelanceProjects
    });
